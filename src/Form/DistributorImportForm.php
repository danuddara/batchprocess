 ...
 */
class DistributorImportForm extends FormBase {
  ...
  public function getFormId() {
    return 'distributor_import_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['break'] = [
      '#type' => 'markup',
      '#markup' => '<div class="row">Are you sure you want to import Distributors?. </div>',
    ];
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
      ...
      if(!empty($this->config->get('brand_selection_coloumn'))){
                ...
                'file'             => drupal_get_path('module', 'trutest_distributor_dealer') . '/csvimport.batch.inc',
                  ...
                  // dpm($batch);
                   //dpm(chr(9));
                if ($csvupload = $this->config->get('importfilePath.distributor')) {
                  ...
                  while ($line = fgetcsv($handle, 2048, chr(9))) {
                   ...
                   if(!empty($line[$brand_col])){   
                      $batch['operations'][] = [
                         ...
                         [array_map('base64_encode', $line),$this->config->get('brand_selection_coloumn'),'Distributor'],
                       ];
                   }
                  }
